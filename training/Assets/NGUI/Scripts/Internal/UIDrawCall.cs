...
public class UIDrawCall : MonoBehaviour
{
	...
	[HideInInspector][System.NonSerialized] public BetterList<Vector2> uvs2 = new BetterList<Vector2>();
		...
		if (count > 0 && (count == uvs.size && count == cols.size) && (count % 4) == 0)
		{
			...
			if (verts.size < 65000)
			{
				...
				bool trim = (uvs.buffer.Length != verts.buffer.Length) ||
					...
					(uvs2.buffer != null && uvs2.buffer.Length != verts.buffer.Length);
				...
				if (trim || verts.buffer.Length > 65000)
				{
					...
					if( uvs2 != null ) mMesh.uv2 = uvs2.ToArray();
				...
				else
				{
					...
					if (uvs2 != null ) mMesh.uv2 = uvs2.buffer;
