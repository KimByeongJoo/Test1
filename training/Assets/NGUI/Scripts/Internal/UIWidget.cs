...
public class UIWidget : UIRect
{
	...
	[System.NonSerialized] float mSortingZ = 0f;
	...
	static public int PanelCompareFunc (UIWidget left, UIWidget right)
	{
		...
		if( left.sorting_z != right.sorting_z ) {
			if (left.sorting_z < right.sorting_z) return -1;
	...
	public void WriteUV2ToBuffers( BetterList<Vector2> u2 )
	{
		geometry.WriteUV2ToBuffers( u2 );
	}
	...
	virtual public void OnFillUV2( BetterList<Vector2> uv2 ) {
		
	}

	virtual public bool useUV2 { get { return false; } }

	[System.NonSerialized] public int custom_param = 0;
}
