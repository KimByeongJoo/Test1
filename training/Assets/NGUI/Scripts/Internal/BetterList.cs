...
[System.Serializable]
public class BetterList<T> : ISerializable
{
#if UNITY_FLASH
    ...
    public void GetObjectData(SerializationInfo info, StreamingContext context)
    {
        ...
        info.AddValue("buffer", buffer, typeof(T[]));
    }

    // The special constructor is used to deserialize values.
    public BetterList(SerializationInfo info, StreamingContext context)
    {
