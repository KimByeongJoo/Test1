...
public class UILabelInspector : UIWidgetInspector
{
	...
	protected override bool ShouldDrawProperties ()
	{
		...
		EditorGUI.BeginDisabledGroup(!isValid);
		{
            ...
            NGUIEditorTools.DrawProperty("Keep Max Lines on Localize", serializedObject, "mKeepMaxLineCountOnLocalize", GUILayout.Width(250f));
            NGUIEditorTools.DrawProperty("Clamp Localize", serializedObject, "mClampOnLocalize", GUILayout.Width(250f));
            NGUIEditorTools.DrawProperty("Localize Font", serializedObject, "mUseLocalizeFont", GUILayout.Width(250f));
