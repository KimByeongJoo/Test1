...
public class UIWrapContent : MonoBehaviour
{
	...
	virtual public void SortBasedOnScrollMovement ()
	{
	...
	virtual public void SortAlphabetically ()
	{
		if (!CacheScrollView()) return;
	...
	virtual protected void ResetChildPositions ()
	{
	...
	//virtual public void WrapContent ()
	//{
    ...
    virtual public void WrapContent(bool forceUpdate = false)
    {
        ...
        if (mHorizontal)
        {
            ...
            for (int i = 0, imax = mChildren.Count; i < imax; ++i)
            {
                ...
                else if (mFirstTime || forceUpdate) UpdateItem(t, i);
